// =============================================
// Reseller Bot - يقرأ من Railway env vars
// =============================================
const { readdirSync, statSync } = require('fs');
const Discord = require('discord.js');

// ============== ENV DEBUG ==============
console.log('=== [RESELLER BOT] ENV DEBUG START ===');
...
console.log('=== [RESELLER BOT] ENV DEBUG END ===');
...
async function Bot(token, data, OurClient) {
    ...
    // ===== Slash command-like prefix commands =====
    ...
    // ===== Buy Members interaction =====
    client.on('interactionCreate', async interaction => {
        if (!interaction.isButton()) return;
        if (interaction.customId !== 'buy_members') return;
