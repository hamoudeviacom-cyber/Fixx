...
client.on('messageCreate', async (message) => {
    ...
    if (command === 'set-bank') {
        ...
        const bank = args[0];
        if (!bank) {
            return message.reply('حط بنك بشكل كويس');
        }
